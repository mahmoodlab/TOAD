...
def train(datasets, cur, args):
    ...
    print('\nInit Loaders...', end=' ')
    train_loader = get_split_loader(train_split, training=True, testing = args.testing, weighted = args.weighted_sample, collate_fn='MIL_sex')
    val_loader = get_split_loader(val_split,  testing = args.testing, collate_fn='MIL_sex')
    test_loader = get_split_loader(test_split, testing = args.testing, collate_fn='MIL_sex')
    print('Done!')
...
def train_loop(epoch, model, loader, optimizer, n_classes, writer = None, loss_fn = None):   
    ...
    for batch_idx, (data, label, sex) in enumerate(loader):
        ...
        logits, Y_prob, Y_hat, _, _ = model(data, sex)
        ...
        train_loss += loss_value
        if (batch_idx + 1) % 5 == 0:
            print('batch {}, loss: {:.4f}, label: {}, sex: {}, bag_size: {}'.format(batch_idx, loss_value, label.item(), sex.item(), data.size(0)))
